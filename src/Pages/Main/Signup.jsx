...
const Signup = () => {
  ...
  return (
    <Container>
      <div className="py-24 flex items-center justify-center h-220">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 bg-slate-900 border border-slate-700 rounded-xl text-white pr-12"
                />
                <button
                  type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-linear-to-r from-cyan-400 to-blue-600 text-white py-4 rounded-xl font-semibold"
              >
