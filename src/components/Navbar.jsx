...
const Navbar = () => {
  ...
  return (
    <nav className="glass shadow-lg bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-b border-white/10 sticky top-0 z-50 ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link to="/signup">
              <button className="px-6 py-2 bg-gradient-to-r from-cyan-400 to-blue-600 text-white rounded-lg hover:from-cyan-500 hover:to-blue-700 transition-all duration-200 shadow-md hover:shadow-lg">
                Sign Up
              </button>
            </Link>
          </div>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex space-x-4 pt-4 border-t border-white/10">
                ...
                <Link to="/signup" onClick={() => setIsMenuOpen(false)}>
                  <button className="px-6 py-2 bg-gradient-to-r from-cyan-400 to-blue-600 text-white rounded-lg hover:from-cyan-500 hover:to-blue-700 transition-all duration-200">
                    Sign Up
                  </button>
                </Link>
              </div>
